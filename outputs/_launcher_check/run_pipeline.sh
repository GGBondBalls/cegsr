...
if [ ! -f "outputs/data/paper_reasoning_eval.jsonl" ]; then
  echo "Dataset not found: outputs/data/paper_reasoning_eval.jsonl" >&2
...
python scripts/run_pipeline.py --config configs/profiles/dual_4090_vllm_paper.yaml
