...
- **repair_success_rate**: 0.1349
- **num_changed_repairs**: 126
- **repair_flip_to_success**: 13
- **average_trajectory_length**: 4.0
- **average_input_tokens**: 1849.85
- **average_output_tokens**: 250.3675
- **retrieval_hit_usefulness_proxy**: 0.0
- **graph_num_nodes**: 1168
- **graph_num_edges**: 8830
- **repair_target_count::solver**: 122
- **repair_target_count::verifier**: 4
...
- **dataset_accuracy::commonsense_qa**: 0.79
- **dataset_count::commonsense_qa**: 100
- **dataset_accuracy::ai2_arc**: 0.73
- **dataset_count::ai2_arc**: 100
- **dataset_accuracy::boolq**: 0.68
- **dataset_count::boolq**: 100
- **dataset_accuracy::pubmed_qa**: 0.71
- **dataset_count::pubmed_qa**: 100
- **category_accuracy::commonsense**: 0.79
- **category_accuracy::science_mcq**: 0.73
- **category_accuracy::reading_comprehension_yesno**: 0.68
...
- sample_id=commonsenseqa_validation_91 | dataset=commonsense_qa | pred=E. eat cake | gold=A. farm house
