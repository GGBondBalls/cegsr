...
if command -v vllm >/dev/null 2>&1; then
  ...
  python -m vllm.entrypoints.openai.api_server --model /home/fyk/models/Qwen/Qwen2.5-7B-Instruct --host 127.0.0.1 --port 8000 --dtype auto --tensor-parallel-size 2 --gpu-memory-utilization 0.92 --api-key EMPTY --max-model-len 4096 --swap-space 8 --max-num-seqs 16
else
